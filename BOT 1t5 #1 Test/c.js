function getColors(angle, tm, v) {
  return [
((Math.floor(v[0].x / 111) + Math.floor(v[0].y / 111)) % 8 === 0) ? '#00001E' : 'black', // #0 Red Scorpion
((Math.floor(v[0].x / 120) + Math.floor(v[0].y / 15)) % 73 === 0) ? '#43111E' : 'black', // #1 Bright Red Runner
((Math.floor(v[0].x / 111) + Math.floor(v[0].y / 98)) % 7 === 0) ? 'red' : 'black',        // #2 Blue Scorpion
((Math.floor(v[0].x / 111) + Math.floor(v[0].y / 95)) % 16 === 0) ? 'blue' : 'black', // #3 Green Sliders
((Math.floor(v[0].x / 111) + Math.floor(v[0].y / 111)) % 8 === 0) ? 'green' : 'black', // #4 Yellow slider
((Math.floor(v[0].x / 111) + Math.floor(v[0].y / 111)) % 16 === 0) ? 'yellow' : 'black', // #5 Orange slider
((Math.floor(v[0].x / 111) + Math.floor(v[0].y / 111)) % 8 === 0) ? 'purple' : 'black', // #6 Light Pink SLiders
((Math.floor(v[0].x / 111) + Math.floor(v[0].y / 111)) % 16 === 0) ? 'orange' : 'black', // #7 Light Blue Slider
((Math.floor(v[0].x / 111) + Math.floor(v[0].y / 111)) % 8 === 0) ? 'pink' : 'black', // #8 Pink SLiders
((Math.floor(v[0].x / 111) + Math.floor(v[0].y / 111)) % 16 === 0) ? 'cyan' : 'black', // #9 Green Slider
((Math.floor(v[0].x / 111) + Math.floor(v[0].y / 111)) % 8 === 0) ? 'magenta' : 'black', // #10 pastel blue sliders
((Math.floor(v[0].x / 111) + Math.floor(v[0].y / 111)) % 16 === 0) ? 'lime' : 'black', // #11 Deep red slider
((Math.floor(v[0].x / 111) + Math.floor(v[0].y / 111)) % 8 === 0) ? 'teal' : 'black', // #12 dark pink slider
((Math.floor(v[0].x / 111) + Math.floor(v[0].y / 111)) % 16 === 0) ? 'maroon' : 'black', // #13
((Math.floor(v[0].x / 111) + Math.floor(v[0].y / 111)) % 8 === 0) ? 'navy' : 'black', // #14 yellow slider
((Math.floor(v[0].x / 111) + Math.floor(v[0].y / 111)) % 16 === 0) ? 'olive' : 'black', // #15 white sliders
((Math.floor(v[0].x / 111) + Math.floor(v[0].y / 111)) % 8 === 0) ? 'silver' : 'black', // #16
((Math.floor(v[0].x / 111) + Math.floor(v[0].y / 111)) % 16 === 0) ? 'gold' : 'black', // #17
((Math.floor(v[0].x / 111) + Math.floor(v[0].y / 111)) % 8 === 0) ? 'indigo' : 'black', // #18
((Math.floor(v[0].x / 111) + Math.floor(v[0].y / 111)) % 16 === 0) ? 'turquoise' : 'black', // #19 - CRAZY FROG (Flash warning)
`hsl(${tm % 1 * 360}, 100%, 50%)`,                // #20 - The Rainbow
`hsl(${(tm + 1) % 1 * 360}, 100%, 50%)`,  // #21
`hsl(${tm % 72 * 5}, 100%, 50%)`, // #22
`hsl(${(tm + 18) % 72 * 5}, 100%, 50%)`,  // #23
`hsl(${(tm * 180) % 360}, 100%, 50%)`,  // #24 SLIGHTLY DIFF FLASH
`hsl(${((tm + 1) * 180) % 360}, 100%, 50%)`,  // #25
`hsl(${(tm * 5) % 360}, 100%, 50%)`,  // #276CRAZY WHITE FLASH
`hsl(${((tm + 18) * 5) % 360}, 100%, 50%)`, // #27
`hsl(${(tm % 0.25) * 360}, 100%, 50%)`, // #28 CRAZY ORANGE FLASH
`hsl(${((tm + 1) % 0.25) * 360}, 100%, 50%)`, // #29
`hsl(${(tm % 6) * 60}, 100%, 50%)`, // #30
`hsl(${((tm + 18) % 6) * 60}, 100%, 50%)`,  // #31
...
`hsl(${((tm + 18) % 18) * 20}, 100%, 50%)`, // #39 - Plain Lime
